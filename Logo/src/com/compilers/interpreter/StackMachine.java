...
public class StackMachine {
    ...
    public StackMachine(SymbolTable table){
    ...
    public int addOperation(String nombre){
    ...
    public int addOperationInto(String nombre, int posicion){
        try{
    ...
    private void varPush_Eval(){
        stack.push(table.find((String)memory.get(++programCounter)));
    }
    ...
    private void declaracion(){
        table.insert((String)memory.get(++programCounter), ++programCounter); //Apuntamos a la primera instrucción de la función
        int invocados = 0;
    ...
    private void invocar(){   
        ...
        ejecutarFuncion((int)table.find(nombre)); //VAMOS AQUI***************************
    }
