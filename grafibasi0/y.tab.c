...
{
       0,     0,     3,     4,     7,    11,    13,    16,    19
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      10,     0,    -1,    -1,    10,     8,    -1,    10,    11,     8,
      -1,     3,    -1,     4,     3,    -1,     5,     3,    -1,     6,
       3,    -1
};
...
{
  "$end", "error", "$undefined", "NUMBER", "LINE", "CIRCULO", "COLOR",
  "PRINT", "';'", "$accept", "list", "inst", 0
};
#endif
...
#line 18 "forma.y"
    { ((Algo)(yyval).obj).inst=maq.code("constpush");
                maq.code(((Algo)(yyvsp[(1) - (1)]).obj).simb); }
    break;

  case 6:
#line 20 "forma.y"
    { maq.code("constpush");
                maq.code(((Algo)(yyvsp[(2) - (2)]).obj).simb); maq.code("line");}
    break;

  case 7:
#line 22 "forma.y"
    { maq.code("constpush");
                maq.code(((Algo)(yyvsp[(2) - (2)]).obj).simb); maq.code("circulo");}
    break;

  case 8:
#line 24 "forma.y"
    { maq.code("constpush");
                maq.code(((Algo)(yyvsp[(2) - (2)]).obj).simb); maq.code("color");}
    break;
